...
if [[ ! -f libusb-1.0.22.tar.bz2  ]] ;
then
	wget http://download.sourceforge.net/project/libusb/libusb-1.0/libusb-1.0.22/libusb-1.0.22.tar.bz2
fi

tar xfv libusb-1.0.22.tar.bz2
